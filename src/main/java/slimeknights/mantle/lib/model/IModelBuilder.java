...
public interface IModelBuilder<T extends IModelBuilder<T>>
{
  ...
  {
    return new Simple(new SimpleBakedModel.Builder(owner.useSmoothLighting(), owner.isSideLit(), owner.isShadedInGui(), owner.getCameraTransforms(), overrides).particle(particle));
  }
