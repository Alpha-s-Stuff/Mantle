...
//    this.validate();
//    parent.save(base -> output.accept(new Result(base, texture, matchAll)));
//  }
//
//  /**
...
//    this.validate();
//    parent.save(base -> output.accept(new Result(base, texture, matchAll)), location);
//  }
//
//  /**
...
//  }
//
//  private static class Result implements RecipeOutput {
//    private final RecipeOutput base;
//    private final Ingredient texture;
//    private final boolean matchAll;
//
//    private Result(RecipeOutput base, Ingredient texture, boolean matchAll) {
//      this.base = base;
//      this.texture = texture;
