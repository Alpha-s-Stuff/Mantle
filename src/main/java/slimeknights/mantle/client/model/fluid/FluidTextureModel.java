...
/** Fluid model that allows a resource pack to control the textures of a block. Use alongside */
...
public class FluidTextureModel implements IUnbakedGeometry<FluidTextureModel> {
  ...
  public BakedModel bake(IGeometryBakingContext owner, ModelBakery bakery, Function<Material,TextureAtlasSprite> spriteGetter, ModelState modelTransform, ItemOverrides overrides, ResourceLocation modelLocation) {
    ...
    BakedModel baked = new SimpleBakedModel.Builder(owner.useAmbientOcclusion(), owner.isGui3d(), owner.useBlockLight(), owner.getTransforms(), overrides).particle(spriteGetter.apply(still)).build();
