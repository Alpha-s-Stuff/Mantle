...
public class SimpleBlockModel implements IUnbakedGeometry<SimpleBlockModel> {
  ...
  @Override
  public BakedModel bake(IGeometryBakingContext context, ModelBakery bakery, Function<Material, TextureAtlasSprite> spriteGetter, ModelState transform, ItemOverrides overrides, ResourceLocation location) {
    return bakeModel(context, transform, overrides, spriteGetter, location);
  }
  ...
  private static class Loader implements IGeometryLoader<SimpleBlockModel> {
    ...
    @Override
    public SimpleBlockModel read(JsonObject json, JsonDeserializationContext context) throws JsonParseException {
