 ...
 * Used to create a baked model wrapper that has a dynamic {@link #getQuads(BlockState, Direction, Random, ModelData)} without worrying about overriding the deprecated variant.
